...
@section('content')
    ...
    <div class="card mb-3">
        <div class='card-header'>
            <div class= 'card-body'>
                <div class="row">
                    <div class="col-8">
                        <form action="/admin/category-article/changeMulti" method="post" form-changed-multi>
                    ...
                    <div class="col-4">
                        <a href='/admin/category-article/create' class="btn btn-outline-success">+Thêm Mới</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <tbody>
                @foreach ($record as $item)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-secondary btn-sm btn-detail" href="/admin/category-article/detail/{{$item->id}}">Chi Tiết</a>
                            <a class="btn btn-warning btn-sm" href="/admin/category-article/edit/{{$item->id}}">Sửa</a>
    ...
    <nav aria-label="Page navigation">
      ...
      <form action="" id="formchangeStatus" method="POST" data-path='/admin/category-article/ChangeStatus/'>
        @csrf
        @method('Patch')
      </form>
      <form action="" id="formDelete" method="POST" data-path ='/admin/category-article/delete/'>
        @csrf
        @method('Delete')
      </form>
@endsection