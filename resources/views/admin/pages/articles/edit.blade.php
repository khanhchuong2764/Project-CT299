    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                ...
                <form action="/admin/article/edit/{{$record->id}}" method="Post" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="categoryarticle_id" class="form-control" id="parentID">
                                <option  value="0">--Chọn Danh Mục--</option>
                                {!! App\Helpers\CategoryHelper::MenuEdit($recordcategory,$record->categoryarticle_id) !!}
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="content1" class="form-control tinymece" rows ="5">{{$record->content}}</textarea>
                        </div>
