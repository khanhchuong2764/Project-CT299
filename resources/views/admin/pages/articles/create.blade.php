                ...
                <form action="/admin/article/create" method="Post" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="content1" class="form-control tinymece" rows ="5"></textarea>
                        </div>
                        <div class="form-group" uploads-image>
                            <label for="thumbnail">Ảnh</label>
                            <input type="file" id="thumbnail" name="file" class="form-control-file" accept="image/*" uploads-image-input required>
