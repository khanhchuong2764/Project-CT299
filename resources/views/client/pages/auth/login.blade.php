    ...
    <div class="container">
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-12 col-md-6 col-lg-4 order-lg-1 order-2">
          <!-- img -->
          <img src="/client/assets/images/svg-graphics/signin-g.svg" alt="" class="img-fluid">
        </div>
        <!-- col -->
        <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
          <div class="mb-lg-9 mb-5">
            <h1 class="mb-1 h2 fw-bold">Đăng Nhập Vào HKC</h1>
            <p>Chào mừng đến với HKC cùng mua sắm nào.</p>
          </div>
          ...
          <form method="post" action="/user/login">
            <div class="row g-3">
              ...
              <div class="d-flex justify-content-between">
                ...
                <div> Quên mật khẩu? <a href="/user/password/forgot">Tạo lại</a></div>
              </div>
              <!-- btn -->
              <div class="col-12 d-grid"> <button type="submit" class="btn btn-primary">Đăng Nhập </button>
              </div>
              <!-- link -->
              <div>Bạn chưa có tài khoản? <a href="/user/register"> Đăng Ký</a></div>
            </div>
            @csrf
          </form>
        </div>
