        ...
        <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1 d-flex align-items-center">
          <div>
            <div class="mb-lg-9 mb-5">
              <!-- heading -->
              <h1 class="mb-2 h2 fw-bold">Bạn quên mật khẩu?</h1>
              <p>Vui lòng nhập địa chỉ Email để tạo một mật khẩu mới!!!</p>
            </div>
            <!-- form -->
...
<!-- btn -->
                <div class="col-12 d-grid gap-2"> <button type="submit" class="btn btn-primary">Gửi Email Xác Nhận</button>
                </div>
